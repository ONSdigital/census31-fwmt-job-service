...
import uk.gov.ons.census.fwmt.jobservice.repository.GatewayCaseRecordRepository;
...
public class GatewayCaseRecordService {
  ...
  public GatewayCaseRecord getByOriginalCaseId(String caseId) {
  ...
  public GatewayCaseRecord save(GatewayCaseRecord cache) {
